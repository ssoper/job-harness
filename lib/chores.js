      ...
      async.waterfall([
        ...
        function(result, started, wf) {
          getRunInfo(name, started, function(err, stats) {
            ...
            result.completed = moment(stats.started).from(moment(stats.ended));
            wf(err, result);
          });
        },
        function(result, wf) {
...
/*
* name, desc, timeout, last started, last finished, time to complete, avg time to complete, current state
*/
